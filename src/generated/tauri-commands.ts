...
export type FocusState = { area: SidebarFocusArea; index: number }
...
export type SidebarFocusArea = "pinned" | "tabs"
...
export type ViewState = { type: "cards"; id: UUIDv7Base64URL; title: string; flex_grow: number; pinned: boolean } | { type: "outline"; id: UUIDv7Base64URL; title: string; flex_grow: number; pinned: boolean } | { type: "document"; id: UUIDv7Base64URL; title: string; flex_grow: number; pinned: boolean } | { type: "timeline"; flex_grow: number; pinned: boolean } | { type: "relation"; id: UUIDv7Base64URL; title: string; direction: RelationDirection; flex_grow: number; pinned: boolean } | { type: "search"; query: string; scope: UUIDv7Base64URL | null; flex_grow: number; pinned: boolean }
