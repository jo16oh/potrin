...
export type ParagraphPositionIndex = Partial<{ [key in string]: ParagraphPositionIndexItem }>
export type ParagraphPositionIndexItem = { prevId: UUIDv7Base64URL | null; isLast: boolean }
...
export type TimelineDay = { dayStart: number; paragraphPositionIndex: ParagraphPositionIndex; paragraphs: Paragraph[]; outlines: Outline[] }
...
export type ViewState = { type: "cards"; id: string; outlineId: UUIDv7Base64URL | null; title: string; viewWidthRatio: number; scrollPosition: number; focusPosition: FocusPosition } | { type: "outline"; id: string; outlineId: UUIDv7Base64URL | null; title: string; viewWidthRatio: number; scrollPosition: number; focusPosition: FocusPosition } | { type: "document"; id: string; outlineId: UUIDv7Base64URL | null; title: string; viewWidthRatio: number; scrollPosition: number; focusPosition: FocusPosition } | { type: "timeline"; id: string; viewWidthRatio: number; position: TimelinePosition | null } | { type: "relation"; id: string; outlineId: UUIDv7Base64URL; title: string; direction: RelationDirection; viewWidthRatio: number; scrollPosition: number } | { type: "search"; id: string; query: string; scope: UUIDv7Base64URL | null; viewWidthRatio: number; scrollPosition: number }
