...
export namespace Prisma {
  ...
  */
  ...
  type GetCardsGroupByPayload<T extends CardsGroupByArgs> =
  ...
  export type CardsSelectCreateManyAndReturn<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = $Extensions.GetSelect<
    {
      id?: boolean;
  ...
  type CardsGetPayload<
    S extends boolean | null | undefined | CardsDefaultArgs,
  > = $Result.GetResult<Prisma.$CardsPayload, S>;
  ...
  > {
    [K: symbol]: {
      types: Prisma.TypeMap<ExtArgs>["model"]["Cards"];
      meta: { name: "Cards" };
    };
    /**
    ...
    findMany<T extends CardsFindManyArgs<ExtArgs>>(
      ...
      $Result.GetResult<Prisma.$CardsPayload<ExtArgs>, T, "findMany">
    >;
    ...
    createManyAndReturn<T extends CardsCreateManyAndReturnArgs<ExtArgs>>(
      ...
      $Result.GetResult<Prisma.$CardsPayload<ExtArgs>, T, "createManyAndReturn">
    >;
  ...
  interface CardsFieldRefs {
    ...
    readonly prev_card: FieldRef<"Cards", "String">;
   ...
   */
  export type CardsCreateManyAndReturnArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the Cards
  ...
  > {
    ...
    findFirst<T extends ThreadsFindFirstArgs<ExtArgs>>(
      ...
      $Result.GetResult<Prisma.$ThreadsPayload<ExtArgs>, T, "findFirst"> | null,
      null,
      ExtArgs
    >;
    ...
    findFirstOrThrow<T extends ThreadsFindFirstOrThrowArgs<ExtArgs>>(
      ...
      $Result.GetResult<Prisma.$ThreadsPayload<ExtArgs>, T, "findFirstOrThrow">,
      never,
      ExtArgs
    >;
    ...
    findMany<T extends ThreadsFindManyArgs<ExtArgs>>(
      ...
      $Result.GetResult<Prisma.$ThreadsPayload<ExtArgs>, T, "findMany">
    >;
    ...
    create<T extends ThreadsCreateArgs<ExtArgs>>(
      ...
      $Result.GetResult<Prisma.$ThreadsPayload<ExtArgs>, T, "create">,
      never,
      ExtArgs
    >;
    ...
    delete<T extends ThreadsDeleteArgs<ExtArgs>>(
      ...
      $Result.GetResult<Prisma.$ThreadsPayload<ExtArgs>, T, "delete">,
      never,
      ExtArgs
    >;
    ...
    update<T extends ThreadsUpdateArgs<ExtArgs>>(
      ...
      $Result.GetResult<Prisma.$ThreadsPayload<ExtArgs>, T, "update">,
      never,
      ExtArgs
    >;
    ...
    upsert<T extends ThreadsUpsertArgs<ExtArgs>>(
      ...
      $Result.GetResult<Prisma.$ThreadsPayload<ExtArgs>, T, "upsert">,
      never,
      ExtArgs
    >;
  ...
  interface ThreadsFieldRefs {
    ...
    readonly prev_thread: FieldRef<"Threads", "String">;
  ...
  export type CardsWhereInput = {
    ...
    prev_card?: UuidNullableFilter<"Cards"> | string | null;
  ...
  export type CardsOrderByWithRelationInput = {
    ...
    prev_card?: SortOrderInput | SortOrder;
  ...
  export type CardsScalarWhereWithAggregatesInput = {
    ...
    prev_card?: UuidNullableWithAggregatesFilter<"Cards"> | string | null;
    content?: StringNullableWithAggregatesFilter<"Cards"> | string | null;
    created_at?:
      | DateTimeNullableWithAggregatesFilter<"Cards">
      | Date
      | string
      | null;
    updated_at?:
  ...
  export type ThreadsWhereInput = {
    ...
    prev_thread?: UuidNullableFilter<"Threads"> | string | null;
  ...
  export type ThreadsOrderByWithRelationInput = {
    ...
    prev_thread?: SortOrderInput | SortOrder;
  ...
  export type ThreadsScalarWhereWithAggregatesInput = {
    ...
    prev_thread?: UuidNullableWithAggregatesFilter<"Threads"> | string | null;
  ...
  export type CardsUpdateInput = {
    ...
    prev_card?: NullableStringFieldUpdateOperationsInput | string | null;
  ...
  export type ThreadsUpdateInput = {
    ...
    prev_thread?: NullableStringFieldUpdateOperationsInput | string | null;
   ...
   */
  export type ThreadsArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = ThreadsDefaultArgs<ExtArgs>;
