...
export const CardsScalarFieldEnumSchema = z.enum(['id','thread','fractional_index','content','created_at','updated_at']);

export const ThreadsScalarFieldEnumSchema = z.enum(['id','parent_thread','fractional_index','title','created_at','updated_at','deleted']);
...
export const CardsSchema = z.object({
  ...
  fractional_index: z.string().nullable(),
...
export const CardsSelectSchema: z.ZodType<Prisma.CardsSelect> = z.object({
  ...
  fractional_index: z.boolean().optional(),
...
export const CardsWhereInputSchema: z.ZodType<Prisma.CardsWhereInput> = z.object({
  ...
  fractional_index: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
...
export const CardsOrderByWithRelationInputSchema: z.ZodType<Prisma.CardsOrderByWithRelationInput> = z.object({
  ...
  fractional_index: z.union([ z.lazy(() => SortOrderSchema),z.lazy(() => SortOrderInputSchema) ]).optional(),
...
export const CardsScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.CardsScalarWhereWithAggregatesInput> = z.object({
  ...
  fractional_index: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
...
export const CardsCreateInputSchema: z.ZodType<Prisma.CardsCreateInput> = z.object({
  ...
  fractional_index: z.string().optional().nullable(),
...
export const CardsUpdateInputSchema: z.ZodType<Prisma.CardsUpdateInput> = z.object({
  ...
  fractional_index: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
...
export const CardsCountOrderByAggregateInputSchema: z.ZodType<Prisma.CardsCountOrderByAggregateInput> = z.object({
  ...
  fractional_index: z.lazy(() => SortOrderSchema).optional(),
